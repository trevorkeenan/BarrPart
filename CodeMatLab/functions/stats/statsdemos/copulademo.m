...
% random inputs or noise. The Statistics Toolbox(TM) provides functions to
% create sequences of random data according to many common univariate
...
% multivariate distributions for all marginal distribtions, or in cases
% where the individual variables are from different distributions.
%
...
%   $Revision: 1.1.8.3 $  $Date: 2012/03/05 23:29:02 $
...
hold on; stairs((1:nobs)/nobs, invCDF2,'r'); hold off
legend('X1','X2');
xlabel('Cumulative Probability'); ylabel('X');
