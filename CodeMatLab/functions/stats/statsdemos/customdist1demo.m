...
% This example shows how to use the Statistics Toolbox(TM) function
% |mle| to fit custom distributions to univariate data.
%
...
% this example, <customdist2demo.html Fitting Custom Univariate Distributions,
% Part 2>, covers both of those latter cases.

%   Copyright 2004-2012 The MathWorks, Inc.
%   $Revision: 1.1.8.4 $  $Date: 2012/03/27 18:32:32 $
...
% with the  |statset| function.  We'll also increase the (PDF) function
% evaluation limit.
