...
%   $Revision: 1.1.8.3 $  $Date: 2012/03/05 23:29:13 $
...
% The pre-defined functions provided with the Statistics Toolbox(TM) don't
...
% Statistics Toolbox includes functions for other common lifetime
