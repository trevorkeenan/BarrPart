...
%   $Revision: 1.1.8.2 $  $Date: 2011/05/09 01:27:39 $
    ...
    methods(Access = 'private')
     ...
     methods(Hidden, Static)	 
         function a = empty(varargin)	 
             error(message('stats:NaiveBayes:NoEmptyAllowed', upper(mfilename))); 
         end   
     end
...
error(message('stats:NaiveBayes:NoCatAllowed',upper(mfilename))); 
end
