...
%   $Revision: 1.1.8.2 $  $Date: 2011/10/15 02:06:55 $
...
set(gca,'Color','k');
title(getString(message('stats:rcoplot:title')));
ylabel(getString(message('stats:rcoplot:yaxisLabel')));
xlabel(getString(message('stats:rcoplot:xaxisLabel')));
