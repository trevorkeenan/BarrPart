function [axh,figh] = lassoPlot( B, plotData, varargin )
...
if isequal(plotType,'CV')
    ...
    c = get(h,'children');
    set(h,'color','r','Marker','.','linestyle','none', ...
    ...
    %
    [ax1,ax2,theTraces] = basicTracePlot(ax1,B,xvals,xlabel,xdir,xscale);
...
if isequal(get(src,'Name'),'XScale')
