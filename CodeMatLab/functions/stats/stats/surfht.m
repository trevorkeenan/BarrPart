...
%   $Revision: 1.1.8.3 $  $Date: 2010/09/02 13:56:28 $
...
set(gca,'NextPlot','add','Gridlinestyle','none');
...
vwitnessline = plot(xvertical,yvertical,'w-.');
hwitnessline = plot(xhorizontal,yhorizontal,'w-.');
