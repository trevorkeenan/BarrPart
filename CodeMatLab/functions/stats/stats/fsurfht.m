...
%   $Revision: 1.1.8.4 $  $Date: 2011/08/29 20:38:25 $
...
delete(uigettool(surf_fig,'Exploration.Brushing'))
delete(uigettool(surf_fig,'DataManager.Linking'))
delete(findall(surf_fig,'Tag','figDataManagerBrushTools'))
delete(findall(surf_fig,'Tag','figBrush'))
delete(findall(surf_fig,'Tag','figLinked'))
...
xtext   =uicontrol('Style','text','Units','normalized',...
         ...
         'ForegroundColor','w','String',getString(message('stats:fsurfht:XValue')),'UserData',xgrid);
        
ytext   =uicontrol('Style','text','Units','normalized',...
        'Position',yfieldp + [0 0.05 0 0],'BackgroundColor',fcolor,...
        'ForegroundColor','w','String',getString(message('stats:fsurfht:YValue')),'UserData',ygrid);

ztext   =uicontrol('Style','text','Units','normalized',...
        'Position',zfieldp + [0 0.05 0 0],'BackgroundColor',fcolor,...
        'ForegroundColor','w','String',getString(message('stats:fsurfht:ZValue')),'UserData',zgrid);
...
set(surf_axes,'NextPlot','add','GridLineStyle','none');
...
vwitnessline = plot(xvertical,yvertical,'LineStyle','-.','UserData','vertical_reference');
hwitnessline = plot(xhorizontal,yhorizontal,'LineStyle','-.','UserData','horizontal_reference');
