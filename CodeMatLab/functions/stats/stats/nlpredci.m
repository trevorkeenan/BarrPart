...
%   you to pass an optional name/value pair that specifies the observation 
%   weights to be used for making predictions. 
%
%        Name              Value      
...
%   $Revision: 1.1.8.5 $  $Date: 2012/05/04 00:11:51 $
