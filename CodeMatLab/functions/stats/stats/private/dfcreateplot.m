...
%   $Revision: 1.1.8.3 $  $Date: 2011/08/17 21:29:36 $
...
% We start with the toolbar turned off. This will cue dftoggletoolbar
% to populate the toolbar according to the specs for dfittool.
set(dffig,'Toolbar','none');
