...
%   CI=STATPARAMCI(PARAM,SIGMA,ALPHA,LOGFLAG) compute confidence
%   intervals for parameters with estimated values PARAM and covariance
%   SIGMA.  The confidence level is 100*(1-ALPHA)%. The confidence intervals
%   are based on a normal approximation for the distribution of the parameter
%   estimates.  LOGFLAG indicates which parameters should be approximated 
%   with a normal distribution on the log scale.

%   Copyright 2008 The MathWorks, Inc.
%   $Revision: 1.1.8.2 $  $Date: 2011/08/29 20:38:54 $
