...
%   $Revision: 1.1.8.6 $  $Date: 2011/12/11 08:05:34 $
...
uimenu(h0, 'Label',getString(message('stats:dfstrings:label_ClearCustomDistributions')), 'Position',8,...
           'Callback',{@dfcustomdist,'clear'},'Tag','clearcustom');


set(m5,'Position',9,'Separator','on');
uimenu(h0, 'Label',getString(message('stats:dfstrings:label_PrintToFigure')), 'Position',10,...
