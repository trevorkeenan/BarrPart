...
%   $Revision: 1.1.8.2 $  $Date: 2010/10/08 17:28:59 $
...
if UseCurrentType && ~isempty(ds.plotx) && ~isempty(ds.ploty) && ...
    ...
    case {'pdf' 'hazrate'}
        ...
        [ydata,cens,freq] = getincludeddata(ds,[]); % get data w/o NaNs
        [~,edges] = internal.stats.histbins(ydata,cens,freq,ds.binDlgInfo,F,X);
...
%         ybounds = [];
    ...
    otherwise
        error(message('stats:dfdata:getplotdata:InvalidFunction'));
    end
