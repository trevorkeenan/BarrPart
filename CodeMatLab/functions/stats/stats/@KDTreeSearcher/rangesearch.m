...
%   $Revision: 1.1.6.2 $ $Date: 2011/05/09 01:27:36 $
...
if nargout < 2
    idx = knnsearchmex(X2, Y', [], minExp, obj.cutDim, obj.cutVal, ...
        obj.lowerBounds', obj.upperBounds',obj.leftChild, obj.rightChild, ...
        obj.leafNode,obj.idx,obj.nx_nonan,wasNaNY, [],radius);
else
    [idx, dist]= knnsearchmex(X2, Y',[],minExp, obj.cutDim, obj.cutVal, ...
        obj.lowerBounds', obj.upperBounds',obj.leftChild, obj.rightChild, ...
        obj.leafNode, obj.idx,obj.nx_nonan, wasNaNY, [],radius);
