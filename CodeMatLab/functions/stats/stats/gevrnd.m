...
%   $Revision: 1.1.6.3 $  $Date: 2011/06/06 17:19:11 $

if nargin < 3
    error(message('stats:gevrnd:TooFewInputs'));
end

[err,sizeOut,numelOut] = statsizechk(3,k,sigma,mu,varargin{:});
if err > 0
    error(message('stats:gevrnd:InputSizeMismatch'));
end
if numelOut ~= 1
