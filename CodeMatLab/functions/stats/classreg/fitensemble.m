...
%   (nominal or ordinal), character array, logical vector, numeric vector,
%   or cell array of strings. If Y is a character array, it must have one
%   class label per row.
%
...
%   method of the appropriate class. For example, call
%   ClassificationTree.template if you want to grow an ensemble of
%   classification trees. Usually you need to supply only one weak learner
%   template. If you supply one weak learner with default parameters, you
%   can pass LEARNERS in as a string with the name of the weak learner, for
%   example, 'Tree'. Note that the ensemble performance depends on the
%   parameters of the weak learners and you can get poor performance for
%   weak learners with default parameters.
%
%   Use the following learner names and templates:
%       for classification:
%           'Discriminant'          ClassificationDiscriminant.template
%           'KNN'                   ClassificationKNN.template
%           'Tree'                  ClassificationTree.template
%       for regression:
%           'Tree'                  RegressionTree.template
%
...
% 
%   If X has categorical predictors with many levels, you should use
%   'GentleBoost' or 'LogitBoost' for binary classification by decision
%   trees. Using other algorithms in this case would likely cause long
%   training times and can exhaust memory.
%
...
% 
% See also ClassificationTree.template, RegressionTree.template,
% ClassificationKNN.template, ClassificationDiscriminant.template,
...
%   $Revision: 1.1.6.13 $  $Date: 2012/03/01 02:29:42 $  
