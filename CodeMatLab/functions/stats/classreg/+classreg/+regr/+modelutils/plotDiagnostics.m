...
switch(plottype)
    ...
    case 'covratio'  % Plot of covariance ratio vs row number
        ...
        yref = 1 + [-1 1]*3*p/n;
        h0 = line([xlim';NaN;xlim'],[yref([1 1])';NaN;yref([2 2])'],'Color','k','LineStyle',':','XLimInclude','off','Parent',ax,'DisplayName','Reference line');
    ...
    case 's2_i'  % Plot of leave-one-out variance vs row number
        ...
        yref = model.MSE;
        h0 = line(xlim,[yref yref],'Color','k','LineStyle',':','XLimInclude','off','Parent',ax,'DisplayName','Mean squared error');
        xlabel(ax,getString(message('stats:classreg:regr:modelutils:xylabel_RowNumber')))
