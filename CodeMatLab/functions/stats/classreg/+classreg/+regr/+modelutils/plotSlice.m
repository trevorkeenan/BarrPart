...
%   $Revision: 1.1.6.4 $  $Date: 2011/12/27 16:16:45 $
...
for axnum = 1:n    
    ...
    if plotdata
        ...
        line(double(fitobj.Variables(:,prednum)),ydata(:,1), 'Linestyle','none', 'Marker','o', 'Parent',slice_axes(axnum));
    end
