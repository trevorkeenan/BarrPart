...
%   $Revision: 1.1.6.8 $  $Date: 2011/12/16 16:39:23 $  
    ...
    properties(GetAccess=public,SetAccess=protected,Dependent=true)
        ...
        %
        %   To compute these matrices, ClassificationDiscriminant.fit subtracts the
        %   class means from the input matrix of predictors and uses unbiased
        %   estimates of the covariance.
        %
        %   See also classreg.learning.classif.CompactClassificationDiscriminant,
        %   Mu, ClassificationDiscriminant.fit.
        Sigma;
        ...
        %   means stored in the Mu property and class weights passed to
    ...
    methods
        ...
        %   as Y used for training. Posterior probabilities POSTERIOR are an N-by-K
        ...
        %   in X to the class means for discriminant DISCR. X must be a numeric
        %   matrix of size N-by-P, where P is the number of predictors used for
        %   training this discriminant. M is a numeric matrix of size N-by-K for K
        %   classes.
        %
        ...
        %   See also classreg.learning.classif.CompactClassificationDiscriminant.
            ...
            if ~isnumeric(X) || ~ismatrix(X)
                error(message('stats:classreg:learning:classif:CompactClassificationDiscriminant:mahal:XNotNumeric'));
            end
        ...
        function this = loadobj(obj)
            if isempty(obj.Impl)
                ...
                this = classreg.learning.classif.CompactClassificationDiscriminant(...
                    obj.DataSummary,obj.ClassSummary,obj.PrivScoreTransform,trained);
            else
