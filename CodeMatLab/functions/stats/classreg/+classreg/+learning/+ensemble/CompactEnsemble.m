...
%   $Revision: 1.1.6.10 $  $Date: 2012/01/27 21:05:31 $
    ...
    properties(GetAccess=public,SetAccess=protected)
        ...
        %   P-by-NTrained for P predictors (columns) in the training data X and the
        %   number of trained weak learners NTrained. An element (I,J) of this
        %   matrix is set to true if predictor I was used for training learner J
    ...
    properties(GetAccess=public,SetAccess=protected,Dependent=true)
        ...
        %   The NTrained property is a numeric positive scalar set to the number of
        %   trained weak learners in this ensemble.
        %
        %   See also classreg.learning.ensemble.CompactEnsemble,
    ...
    methods
        ...
        %   integer values ranging from 1 to NTrained.
        %
        %   See also classreg.learning.ensemble.CompactEnsemble, NTrained, Trained.
