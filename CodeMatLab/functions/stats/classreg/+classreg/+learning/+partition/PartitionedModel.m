...
%   $Revision: 1.1.6.8 $  $Date: 2011/10/01 21:37:57 $
    ...
    properties(GetAccess=public,SetAccess=protected,Dependent=true)
        ...
        %   The NObservations property is a numeric positive scalar showing the
        ...
        %   The ModelParams property holds parameters used for cross-validating
        %   this model.
        %
        %   See also ClassificationPartitionedModel, RegressionPartitionedModel. 
        ModelParams;
        ...
        %   The KFold property is an integer scalar showing on how many folds this
