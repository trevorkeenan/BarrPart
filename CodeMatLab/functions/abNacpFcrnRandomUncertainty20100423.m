	function [Ensemble,MatrixNEE]=abNacpFcrnRandomUncertainty20100423 ...
		(t,NEE,uStar,Rsd,Ta,Ts,fNight,uStarTh,DirOut,cSiteYr,nMC,iFig,k) 
...
%	-	estimates MuHat = f(NEEhat) for each period from the fitted lines.
	...
	[MuHat,b,cib,r2,s,mxNeg,myNeg,mxPos,myPos,bNeg,bPos]= ...
		abNacpRandomUncertaintyVPlot20100105_2(xNEE,xNEEhat,iFig,cSiteYr);
