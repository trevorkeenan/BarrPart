	function [Ensemble,MatrixNEE,bNeg,bPos]=abNacpFcrnRandomUncertainty20100423_LE2 ...
		(t,NEE,NEEhat,uStar,PPFD,Ta,Ts,fNight,uStarTh,DirOut,cSiteYr,nMC,iFig,k,cFlux) 
...
% NEEhat is now input from previous calculation
...
% 			(t,xNEEnoisy,uStar,Rsd,Ta,Ts,Rsd,Ta,Ts,fNight,uStarTh,FracSEBClosure,cSiteYr,fPlot); 
        ...
        (t,xNEEnoisy,uStar,PPFD,Ta,Ts,PPFD,Ta,Ts,fNight,uStarTh,FracSEBClosure,cSiteYr,fPlot);
...
%	=======================================================================
	...
	if iFig>0 % for LE and H don't plot components
