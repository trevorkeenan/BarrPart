...
%   $Revision: 1.1.8.12 $  $Date: 2012/04/30 03:10:02 $
...
elseif isequal(orientation,1)
    ...
    orientation = getParamVal(orientation,{'horizontal' 'vertical'},'''Orientation''');
end
...
factordirection = getParamVal(factordirection, ...
...
elseif isequal(plotstyle,1)
    ...
    plotstyle = getParamVal(plotstyle,{'traditional' 'compact'},'''PlotStyle''');
end
...
labelverbosity = getParamVal(labelverbosity,...
